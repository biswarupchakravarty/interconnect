(function(){var d=window||process;d.Appacitive||(d.Appacitive={runtime:{isNode:"undefined"!=typeof process,isBrowser:"undefined"!=typeof window}});var e=function(a){if(!a||!a.send||"function"!=typeof a.send)throw Error("No applicable httpTransport class found");a.onResponse=this.onResponse;var c=[],b={},d=0,g={},e=0;this.addProcessor=function(a){if(a){a.pre=a.pre||function(){};a.post=a.post||function(){};var c=a.pre;d+=1;b[d]=c;a=a.post;e+=1;g[e]=a}};this.enqueueRequest=function(a){c.push(a)};this.notify=
function(){if(0!=c.length){var d=[],h;for(h in g)g.hasOwnProperty(h)&&d.push(g[h]);for(;0<c.length;){var e=c.shift(),l=[];for(h in b)b.hasOwnProperty(h)&&l.push(b[h](e));a.send(e,d,l)}}};this.onResponse=function(a){console.dir(a)}},b=function(){var a=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=a;this.onResponse=function(){a()};this.onError=function(){a()}},a=function(){var a=new b;a.type="jQuery based http provider";a.send=function(a,b,f){"function"==typeof a.beforeSend&&
a.beforeSend(a);switch(a.method.toLowerCase()){case "get":$.ajax({url:a.url,type:"GET",async:a.async,beforeSend:function(c){for(var b=0;b<a.headers.length;b+=1)c.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=JSON.parse(e)}catch(m){}c(e,b,f);d.onResponse(e,a)},error:function(){d.onError(a)}});break;case "post":$.ajax({url:a.url,type:"POST",async:a.async,contentType:"application/json",data:JSON.stringify(a.data),beforeSend:function(c){for(var b=0;b<a.headers.length;b+=
...
break;case "delete":$.ajax({url:a.url,type:"DELETE",async:a.async,beforeSend:function(c){for(var b=0;b<a.headers.length;b+=1)c.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=JSON.parse(e)}catch(m){}c(e,b,f);d.onResponse(e,a)},error:function(){d.onError(a)}});break;default:throw Error("Unrecognized http method: "+a.method);}};a.isOnline=function(){return window.navigator.onLine||!0};var c=function(a,c,b){if(c.length!=b.length)throw Error("Callback length and state length mismatch!");
for(var f=0;f<c.length;f+=1)c[f].apply({},[a,b[f]])},d=a;$=$||{};$.ajax=$.ajax||{};return a};d.Appacitive.http=new function(){var c=(window||process).Appacitive.runtime.isBrowser?new a:NodeHttpTransport(),b=new e(c);_paused=!1;this.pause=function(){_paused=!0};this.unpause=function(){_paused=!1};this.addProcessor=function(a){var c=Error('Must provide a processor object with either a "pre" function or a "post" function.');if(!a)throw c;if(!a.pre&&!a.post)throw c;b.addProcessor(a)};this.send=function(a){b.enqueueRequest(a);
c.isOnline()&&!1==_paused&&b.notify()};this.flush=function(a){a?b.notify():c.isOnline()&&b.notify()};this.onError=function(a){if(a.onError)if(a.context)a.onError.apply(a.context,[]);else a.onError()};c.onError=this.onError;this.onResponse=function(a,c){if(c.onSuccess)if(c.context)c.onSuccess.apply(c.context,[a]);else c.onSuccess(a)};c.onResponse=this.onResponse};d.Appacitive.HttpRequest=function(){this.url="";this.data={};this.async=!0;this.headers=[];this.method="GET"};d=window||process;d.Appacitive&&
d.Appacitive.http&&d.Appacitive.http.addProcessor({pre:function(){return(new Date).getTime()},post:function(a,c){var b=(new Date).getTime()-c;a._timeTakenInMilliseconds=b}});var c=window||process;c.Appacitive&&c.Appacitive.http&&c.Appacitive.http.addProcessor({pre:function(a){return a},post:function(a,b){c.Appacitive.session.isSessionValid(a)||(null!=c.Appacitive.session.get()&&(c.Appacitive.session.resetSession(),c.Appacitive.session.onSessionCreated=function(){c.Appacitive.http.unpause();c.Appacitive.http.flush();
c.Appacitive.session.onSessionCreated=function(){}},c.Appacitive.session.recreate(),c.Appacitive.http.pause()),c.Appacitive.http.send(b))}})})();
...
"",c=0;c<b.length;c+=1)-1==" .,;#".indexOf(b[c])&&(a+=b[c]);return a=a.toLowerCase()};String.contains=function(b,a){return-1!=b.indexOf(a)};String.startsWith=function(b,a){return 0==b.indexOf(a)};window.dateFromWcf=function(b,a){var c=/Date\(([^)]+)\)/.exec(b);if(2!=c.length){if(!a)return s;throw Error(s+" is not .net json date.");}return new Date(parseFloat(c[1]))};var e=function(){d.Appacitive=d.Appacitive||{};d.Appacitive.bag=d.Appacitive.bag||{};d.Appacitive.bag.accountName=d.Appacitive.bag.accountName||
{};d.Appacitive.bag.selectedType=d.Appacitive.bag.selectedType||{};d.Appacitive.bag.apps=d.Appacitive.bag.apps||{};d.Appacitive.bag.apps.selected=d.Appacitive.bag.apps.selected||{};d.Appacitive.bag.apps.selected.name=d.Appacitive.bag.apps.selected.name||{};d.Appacitive.bag.selectedCatalog=d.Appacitive.bag.selectedCatalog||{};d.Appacitive.bag.selectedCatalog.Id=d.Appacitive.bag.selectedCatalog.Id||0;d.Appacitive.bag.selectedCatalog.blueprintid=d.Appacitive.bag.selectedCatalog.blueprintid||0;d.Appacitive.bag.selectedCatalog.BlueprintId=
...
this.deploymentServiceUrl,"__Sandbox_"+d.Appacitive.bag.apps.selected.name,a)}};this.tag={tagServiceUrl:b+"/tagsservice",getEntityId:function(){return"deployment"==d.Appacitive.selectedType?d.Appacitive.bag.selectedCatalog.blueprintid:d.Appacitive.bag.selectedCatalog.id},getAddTagUrl:function(a,b,d,e){return String.format("{0}/addTag/{1}/{2}/{3}/{4}?tag={5}",this.tagServiceUrl,this.getEntityId(),a,b,d,e)},getRemoveTagUrl:function(a,b,d,e){return String.format("{0}/removeTag/{1}/{2}/{3}/{4}?tag={5}",
this.tagServiceUrl,this.getEntityId(),a,b,d,e)}};this.invoice={invoiceServiceUrl:b+"/invoiceservice",getUsageStatsUrl:function(){return this.invoiceServiceUrl+"/usage/"+d.Appacitive.bag.accountName}};this.account={accountServiceUrl:b+"/accountservice",getCreateNewAccountUrl:function(a){return String.format("{0}/createaccount?skipValid={1}",this.accountServiceUrl,a)},getAccountIdUrl:function(a){return this.accountServiceUrl+"/accountId/"+a},checkAccountNameUrl:function(a){return this.accountServiceUrl+
...
e){var k=e.split("="),h=k[1];2<k.length&&k.forEach(function(a){0==a||1==a||(h=h+"="+k[a])});k[0].toLowerCase()==a&&(b=[k[0],h])}),b):location.search.split("?")[1].split("=")}};this.announcement={announcementServiceUrl:b+"/announcementservice",getSummaryUrl:function(){return this.announcementServiceUrl+"/summary"}};this.graphite={graphiteBaseUrl:b+"/sessionservice/getGraph",getBaseUrl:function(){return this.graphiteBaseUrl}};this.emailtemplate={emailTemplateServiceUrl:b+"/emailservice",getCreateUrl:function(){return this.emailTemplateServiceUrl+
"/create"},getUpdateUrl:function(a){return this.emailTemplateServiceUrl+"/"+a},getAllNames:function(){return this.emailTemplateServiceUrl+"/find/all"},getSearchByNameUrl:function(a){return this.emailTemplateServiceUrl+"/"+a},getDeleteUrl:function(a){return this.emailTemplateServiceUrl+"/"+a}}};d.Appacitive.storage=d.Appacitive.storage||{};d.Appacitive.storage.urlFactory=new e})(window||process);
(function(d){d.Appacitive.eventManager=new function(){var d={};this.subscribe=function(b,a){if("string"!=typeof b||"function"!=typeof a)throw Error("Incorrect subscription call");"undefined"==typeof d[b]&&(d[b]=[]);var c;c=function(){return Math.floor(65536*Math.random()).toString(16)};c=c()+c()+"-"+c()+"-"+c()+"-"+c()+"-"+c()+c()+c();d[b].push({callback:a,id:c});return c};this.unsubscribe=function(b){if(!b)return!1;var a=-1,c=null,f;for(f in d)for(var j=0;j<d[f].length;j+=1)if(d[f][j].id==b){a=j;
...
function(b){if("string"!=typeof b)throw Error("Event Name must be string in EventManager.clearSubscriptions");d[b]&&(d[b].length=0);return this};this.clearAndSubscribe=function(b,a){this.clearSubscriptions(b);this.subscribe(b,a)};this.dump=function(){console.dir(d)}}})(window||process);var _function=function(d,e){console.log("i subscribe to "+e.eventName)};window.Appacitive.eventManager.fire("unit.test");(function(d){d.Appacitive.config={apiBaseUrl:"https://apis.appacitive.com/"}})(window||process);
...
var j="sandbox";this.__defineGetter__("environment",function(){return j});this.__defineSetter__("environment",function(a){"sandbox"!=a&&"live"!=a&&(a="sandbox");j=a})}})(window||process);(function(d){d.Appacitive&&d.Appacitive.http&&d.Appacitive.http.addProcessor({pre:function(e){e.headers.push({key:"appacitive-environment",value:d.Appacitive.session.environment})}})})(window||process);
...
b.relation+"/"+b.articleId+"/find?"+f.pageQuery.toString()+"&"+f.sortQuery.toString();return a};this.extendOptions=function(){f.extendOptions.apply(f,arguments)};this.setFilter=function(){f.setFilter.apply(f,arguments)}}})(window||process);
(function(d){d.Appacitive.BaseObject=function(e){_snapshot=null;var b=e=e||{};this.fetch=function(a,c){a=a||function(){};c=c||function(){};if(b.__id){var e=this,h=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[this.type].getGetUrl(b.__schematype||b.__relationtype,b.__id),g=new d.Appacitive.HttpRequest;g.url=h;g.method="get";g.onSuccess=function(d){if(d&&d.article){_snapshot=d.article;b.__id=d.article.__id;for(var g in d.article)"undefined"==typeof b[g]&&(b[g]=d.article[g]);e.___collection&&
"article"==e.___collection.collectionType&&e.___collection.addToCollection(e);a()}else c()};d.Appacitive.http.send(g)}else c()};this.del=function(a,c,e){a=a||function(){};c=c||function(){};e=e||{};if(b.__id){var h=this,g=d.Appacitive.config.apiBaseUrl,g=g+d.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||b.__relationtype,b.__id);b&&(b.__schematype&&"user"==b.__schematype.toLowerCase())&&(g=d.Appacitive.config.apiBaseUrl,g+=d.Appacitive.storage.urlFactory.user.getUserDeleteUrl(b.__id));
...
throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};this.get=function(a){if(a)return b[a]};this.set=function(a,c){a&&(b[a]=c);return c};this.save=function(d,e){b.__id?a.apply(this,arguments):c.apply(this,arguments)};var a=function(a,c){var e=!1,h=JSON.parse(JSON.stringify(_snapshot)),g;for(g in b)"undefined"==typeof b[g]||null==b[g]?(h[g]=null,e=!0):b[g]!=_snapshot[g]?(h[g]=b[g],e=!0):b[g]==_snapshot[g]&&delete h[g];e&&(e=new d.Appacitive.HttpRequest,
e.url=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[this.type].getUpdateUrl(b.__schematype,_snapshot.__id),e.method="post",e.data=h,e.onSuccess=function(b){b&&(b.article||b.connection||b.user)?(_snapshot=b.article,"function"==typeof a&&a()):"function"==typeof c&&c()},d.Appacitive.http.send(e))},c=function(a,c){var e=this,h=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[this.type].getCreateUrl(b.__schematype||b.__relationtype);b.__schematype&&"user"==b.__schematype.toLowerCase()&&
(h=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory.user.getCreateUserUrl());var g=new d.Appacitive.HttpRequest;g.url=h;g.method="put";g.data=b;g.onSuccess=function(d){var g=null;d&&(g=d.article||d.connection||d.user);if(d&&g){_snapshot=g;b.__id=g.__id;for(var h in g)"undefined"==typeof b[h]&&(b[h]=g[h]);e.connectionCollections&&0<e.connectionCollections.length&&e.connectionCollections.forEach(function(a){a.getQuery().extendOptions({articleId:b.__id})});"function"==typeof a&&a()}else"function"==
typeof c&&c()};d.Appacitive.http.send(g)}}})(window||process);
(function(d){var e=function(){return Math.floor(65536*Math.random()).toString(16)};d.Appacitive.GUID=function(){var b=e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e(),a="",c,d,j,k,h,g,l=0,b=b.replace(/\r\n/g,"\n");d="";for(j=0;j<b.length;j++)k=b.charCodeAt(j),128>k?d+=String.fromCharCode(k):(127<k&&2048>k?d+=String.fromCharCode(k>>6|192):(d+=String.fromCharCode(k>>12|224),d+=String.fromCharCode(k>>6&63|128)),d+=String.fromCharCode(k&63|128));for(b=d;l<b.length;)c=b.charCodeAt(l++),d=b.charCodeAt(l++),
j=b.charCodeAt(l++),k=c>>2,c=(c&3)<<4|d>>4,h=(d&15)<<2|j>>6,g=j&63,isNaN(d)?h=g=64:isNaN(j)&&(g=64),a=a+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g);return a.toString()}})(window||process);
(function(d){d.Appacitive.ArticleCollection=function(e){var b=null,a=null,c=[],f=e;this.collectionType="article";if(!e||!e.schema)throw Error("Must provide schema while initializing ArticleCollection.");var j=this,k=function(c){b=c.schema;c.type="article";a=new d.Appacitive.queries.SearchAllQuery(c);j.extendOptions=a.extendOptions;f=c};this.setFilter=function(c){f.filter=c;f.type="article";f.schema=b;a=new d.Appacitive.queries.BasicFilterQuery(e)};this.reset=function(){b=f=null;c.length=0;a=null};
this.getQuery=function(){return a};this.setOptions=k;k(e);this.get=function(a){if(a!=parseInt(a))return null;a=parseInt(a);return"number"!=typeof a||a>=c.length?null:c.slice(a,a+1)[0]};this.addToCollection=function(a){if(!a||a.get("__schematype")!=b)throw Error("Null article passed or schema type mismatch");var d=null;c.forEach(function(b,c){b.get("__id")==a.get("__id")&&(d=c)});null!=d?c.splice(d,1):c.push(a)};this.getArticle=function(a,b,d){b=b||function(){};d=d||function(){};var e=c.filter(function(b){return b.get("__id")==
a});1==e.length?b(Array.prototype.slice.call(e)[0]):d()};this.getAll=function(){return Array.prototype.slice.call(c)};this.removeById=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.getArticle().__id&&c.getArticle().__id==a&&(b=d)});return null!=b?(c.splice(b,1),!0):!1};this.removeByCId=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.__cid&&c.__cid==a&&(b=d)});return null!=b?(c.splice(b,1),!0):!1};j=this;this.fetch=function(b,e){b=b||function(){};e=e||function(){};
c.length=0;var f=a.toRequest();f.onSuccess=function(a){var f=b;if(a=a.articles){if(!a.length||0==a.length)a=[];a.forEach(function(a){a=new d.Appacitive.Article(a);a.___collection=j;c.push(a)});f()}else e()};d.Appacitive.http.send(f)};this.createNewArticle=function(a){a=a||{};a.__schematype=b;a=new d.Appacitive.Article(a);a.___collection=j;a.__cid=parseInt(1E6*Math.random());c.push(a);return a};this.map=function(){return c.map.apply(this,arguments)};this.forEach=function(){return c.forEach.apply(this,
arguments)};this.filter=function(){return c.filter.apply(this,arguments)}}})(window||process);
(function(d){d.Appacitive.ConnectionCollection=function(e){var b=null,a=null,c=[],f=[],j=e;this.collectionType="connection";if(!e||!e.relation)throw Error("Must provide relation while initializing ConnectionCollection.");var k=function(c){b=c.relation;c.type="connection";a=new d.Appacitive.queries.SearchAllQuery(c);j=c};this.setFilter=function(c){j.filter=c;j.type="connection";j.relation=b;a=new d.Appacitive.queries.BasicFilterQuery(e)};this.setQuery=function(b){if(!b)throw Error("Invalid query passed to connectionCollection");
c.length=0;a=b};this.reset=function(){b=j=null;articles.length=0;c.length=0;a=null};this.getQuery=function(){return a};this.setOptions=k;k(e);this.get=function(a){if(a!=parseInt(a))return null;a=parseInt(a);return"number"!=typeof a||a>=c.length?null:c.slice(a,a+1)[0]};this.addToCollection=function(a){if(!a||a.get("__relationtype")!=b)throw Error("Null connection passed or relation type mismatch");var d=null;c.forEach(function(b,c){b.get("__id")==a.get("__id")&&(d=c)});null!=d?c.splice(d,1):c.push(a)};
this.getConnection=function(a,b,d){b=b||function(){};d=d||function(){};var e=c.filter(function(b){return b.get("__id")==a});1==e.length?b(Array.prototype.slice.call(e)[0]):d()};this.getAll=function(){return Array.prototype.slice.call(c)};this.removeById=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.getConnection().__id&&c.getConnection().__id==a&&(b=d)});return null!=b?(c.splice(b,1),!0):!1};this.removeByCId=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.__cid&&
c.__cid==a&&(b=d)});return null!=b?(c.splice(b,1),!0):!1};var h=this;this.getConnectedArticle=function(a){if(!f||0==f.length)return null;var b=f.filter(function(b){return b.get("__id")==a});return 0<b.length?b[0]:null};this.fetch=function(b,e){b=b||function(){};e=e||function(){};c.length=0;var j=a.toRequest();j.onSuccess=function(a){a:{var j=b;a=a||{};var k=a.connections;if(!k)if(a.status&&a.status.code&&"200"==a.status.code)k=[];else{e();break a}if(!k.length||0==k.length)k=[];k.forEach(function(a){var b=
new d.Appacitive.Connection(a);b.___collection=h;c.push(b);if(a.__endpointa.article||a.__endpointb.article)a=new d.Appacitive.Article(a.__endpointa.article||a.__endpointb.article),a.___collection=h,f.push(a)});j()}};d.Appacitive.http.send(j)};this.createNewConnection=function(a){a=a||{};a.__relationtype=b;a=new d.Appacitive.Connection(a);a.___collection=h;a.__cid=parseInt(1E6*Math.random());c.push(a);return a};this.map=function(){return c.map.apply(this,arguments)};this.forEach=function(a,b){return c.forEach(a,
b||this)};this.filter=function(){return c.filter.apply(this,arguments)}}})(window||process);
...
a.setQuery(b);return a};d.Appacitive.BaseObject.prototype.getConnected=function(b){if("article"==!this.type)return null;b=b||{};b.onSuccess=b.onSuccess||function(){};b.onError=b.onError||function(){};b.articleId=this.get("__id")}})(window||process);
...
d){if(!b||!b.id||b.label||!d||!d.id||d.label)throw Error("Incorrect endpoints configuration passed.");a.set("__endpointa",e(b));a.set("__endpointb",e(d))};return a}})(window||process);
(function(d){d.Appacitive.Users=new function(){authenticatedUser=null;this.__defineGetter__("currentUser",function(){return authenticatedUser});this.deleteCurrentUser=function(d,b){if(null==authenticatedUser)throw Error("Current user is not set yet");this.deleteUser(authenticatedUser.__id,d||function(){},b||function(){})};this.deleteUser=function(e,b,a){b=b||function(){};a=a||function(){};var c=new d.Appacitive.HttpRequest;c.method="delete";c.url=d.Appacitive.config.apiBaseUrl;c.url+=d.Appacitive.storage.urlFactory.user.getUserDeleteUrl(e);
c.onSuccess=function(c){c&&c.code&&"200"==c.code?b(c):(c=c||{},c.message=c.message||"Server error",a(c))};c.onError=a;d.Appacitive.http.send(c)};this.createUser=function(e,b,a){b=b||function(){};a=a||function(){};e=e||{};e.__schematype="user";if(!e.username||!e.password)throw Error("Username and password are mandatory");var c=new d.Appacitive.HttpRequest;c.method="put";c.url=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory.user.getCreateUserUrl();console.log("SAVE: "+c.url);c.data=e;
c.onSuccess=function(c){c&&c.user?b(c.user):a((c||{}).status||"No response from APIs.")};c.onError=a;d.Appacitive.http.send(c)};this.authenticateUser=function(e,b,a){b=b||function(){};a=a||function(){};var c=new d.Appacitive.HttpRequest;c.method="post";c.url=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();c.data=e;c.onSuccess=function(c){c&&c.user?(authenticatedUser=c.user,b(c)):(c=c||{},a(c.status))};c.onError=a;d.Appacitive.http.send(c)};this.authenticateWithFacebook=
this.signupWithFacebook=function(d,b){d=d||function(){};b=b||function(){};FB.api("/me",function(){var a={accesstoken:Appacitive.facebook.accessToken,type:"facebook",expiry:3600,attempts:-1,createnew:!0},c=new Appacitive.HttpRequest;c.url=Appacitive.config.apiBaseUrl+Appacitive.storage.urlFactory.user.getAuthenticateUserUrl();c.method="post";c.data=a;c.onSuccess=function(a){a.user?(authenticatedUser=a.user,d(a)):b(a)};c.onError=function(){b()};Appacitive.http.send(c)})}}})(window||process);
...
Appacitive.storage.urlFactory.email.getSendEmailUrl();f.method="post";f.data=b;f.onSuccess=function(b){b&&b.status&&"200"==b.status.code?a(b.email):(b=b||{},b.status=b.status||{},c(b.status.message||"Server error"))};d.Appacitive.http.send(f)}}})(window||process);
(function(d){d.Appacitive.facebook=new function(){_accessToken=null;this.requestLogin=function(d,b){d=d||function(){};b=b||function(){};FB?FB.login(function(a){a.authResponse?(_accessToken=a.authResponse.accessToken,d(a.authResponse)):b()},{scope:"email,user_birthday"}):b()};this.getCurrentUserInfo=function(d,b){d=d||function(){};b=b||function(){};FB.api("/me",function(a){a?d(a):b()})};this.__defineGetter__("accessToken",function(){return _accessToken});this.__defineSetter__("accessToken",function(d){_accessToken=
d});this.getProfilePictureUrl=function(d){return"https://graph.facebook.com/"+d+"/picture"};this.logout=function(d,b){d=d||function(){};b=b||function(){};try{FB.logout(function(){d()})}catch(a){b(a.message)}}}})(window||process);